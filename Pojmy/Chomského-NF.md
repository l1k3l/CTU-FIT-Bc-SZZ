...
## Greibachové NF (pro úplnost)

**GNF:** $A \to a\alpha$, $a \in \Sigma$, $\alpha \in N^*$. Každý CFL má gramatiku v GNF. Délka derivace věty $w$ je přesně $|w|$. Užitečné pro top-down syntaktickou analýzu.
